...
- For complex tasks, refer to the relevant use case in `docs/requirements/use-cases` and the new feature-based breakdown in `docs/specs/features`.
- Create or update `SPECS.md` / `PLANS.md` / `TASKS.md` in feature folders for implementation work.
