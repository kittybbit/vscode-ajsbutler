...
| Effective Cloud gate and committed configuration agree                                 | Requirements; Impact Analysis; Open Questions    | Slice 1              | Cloud Project Settings record; `.qlty/qlty.toml` review             |
