...
- Approved or active slice: Slice 1 is complete; Slice 2 is active; Slices 3–6
  remain approved and queued.
- Do not: edit runtime code, tests, generated artifacts, packaging
  configuration, role definitions, routing, or Feature Exit procedures in
  Slice 1.
...
- Active implementation slice: Slice 2 — Planning Lifecycle Role Definitions
