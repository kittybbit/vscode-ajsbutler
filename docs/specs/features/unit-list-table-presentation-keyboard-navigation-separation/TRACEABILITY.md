...
| `uc-view-unit-list.md`: rapid keyboard movement keeps tree/detail side effects responsive while final selection remains stable                   | R5, R8; AC3, AC5, AC7            | Slice 4              | `tableNavigation.test.ts`, `tableVirtualizationFocus.test.ts`, `tableShellIntegration.test.ts`, detail/accessibility tests, manual large-list keyboard smoke |
