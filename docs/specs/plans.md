...
- `docs/specs/features/migrate-flow-graph-and-navigation-boundaries/`: all four
  approved slices are complete and the active feature awaits Feature Exit
  Review.
