...
export class Evwj extends UnitEntity implements WaitableUnit {
  // [evwid=event-ID;]
  get evwid() {
    return ParamFactory.evwid(this);
  }
  // [evusr="event-issue-source-user-name";]
  get evusr() {
    return ParamFactory.evusr(this);
  }
  // [evgrp="event-issue-source-group-name";]
  get evgrp() {
    return ParamFactory.evgrp(this);
  }
  ...
  get evipa() {
    return ParamFactory.evipa(this);
  }
  // [evwms="message";]
  get evwms() {
    return ParamFactory.evwms(this);
  }
  // [evdet="detailed-event-information";]
  get evdet() {
    return ParamFactory.evdet(this);
  }
  // [evwsv=em[:al[:cr[:er[:wr[:no[:in[:db]]]]]]];]
  get evwsv() {
    return ParamFactory.evwsv(this);
  }
  // [evwfr=optional-extended-attribute-name:"value";]
  get evwfr() {
    return ParamFactory.evwfr(this);
  }
  // [evtmc={n|a|n:"file-name"|a:"file-name"
  //      |d:"file-name"|b:"file-name"};]
  get evtmc() {
    return ParamFactory.evtmc(this);
  }
  // [evuid=event-issue-source-user-ID;]
  get evuid() {
    return ParamFactory.evuid(this);
  }
  // [evgid=event-issue-source-group-ID;]
  get evgid() {
    return ParamFactory.evgid(this);
  }
  // [evpid=event-issue-source-process-ID;]
  get evpid() {
    return ParamFactory.evpid(this);
  }
  ...
  // [evesc={no|minutes};]
  get evesc() {
    return ParamFactory.evesc(this);
  }
  // [ets={kl|nr|wr|an};]
  get ets() {
