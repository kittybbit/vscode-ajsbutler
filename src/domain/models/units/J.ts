...
export class J extends UnitEntity {
    ...
    // [top1={sav|del};]
    get top1() { return ParamFactory.top1(this, this.#top(1)); }
    ...
    // [top2={sav|del};]
    get top2() { return ParamFactory.top2(this, this.#top(2)); }
    ...
    // [top3={sav|del};]
    get top3() { return ParamFactory.top3(this, this.#top(3)); }
    ...
    // [top4={sav|del};]
    get top4() { return ParamFactory.top4(this, this.#top(4)); }
    // [ha={y|n};]
