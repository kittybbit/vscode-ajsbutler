...
export class J extends UnitEntity implements PrioritizableUnit, WaitableUnit {
  // [te="command-text";]
  get te() {
    return ParamFactory.te(this);
  }
  // [sc="script-file-name";]
  get sc() {
  ...
  // [wkp="work-path-name";]
  get wkp() {
    return ParamFactory.wkp(this);
  }
  // [ev="environmental-variable-file-name";]
  get ev() {
    return ParamFactory.ev(this);
  }
  ...
  // [soa={new|add};]
  get soa() {
    return ParamFactory.soa(this);
  }
  // [sea={new|add};]
  get sea() {
    return ParamFactory.sea(this);
  }
  // [etm=n;]
  get etm() {
