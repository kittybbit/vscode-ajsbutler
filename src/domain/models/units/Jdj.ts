...
export class Jdj extends UnitEntity {
  ...
  get ej() {
    return ParamFactory.ej(this);
  }
  // [ejc=judgment-return-code;]
  get ejc() {
    return ParamFactory.ejc(this);
  }
  // [ejl=lower-limit-of-judgment-return-codes;]
  get ejl() {
    return ParamFactory.ejl(this);
  }
  // [ejh=upper-limit-of-judgment-return-codes;]
  get ejh() {
    return ParamFactory.ejh(this);
  }
  // [ejf="end-judgment-file-name";]
  get ejf() {
    return ParamFactory.ejf(this);
  }
  // [ejv=variable-name;]
  get ejv() {
    return ParamFactory.ejv(this);
  }
  // [ejt="judgment-value-for-variable (string)";]
  get ejt() {
    return ParamFactory.ejt(this);
  }
  // [eji=judgment-value-for-variable (numeric);]
  get eji() {
    return ParamFactory.eji(this);
  }
  // [ejs=lower-limit-judgment-value-for-variable_(numeric);]
  get ejs() {
    return ParamFactory.ejs(this);
  }
  // [ejg=upper-limit-judgment-value-for-variable_(numeric);]
  get ejg() {
    return ParamFactory.ejg(this);
  }
  // [ejm={gt|ge};]
  get ejm() {
    return ParamFactory.ejm(this);
  }
  // [eju={lt|le};]
  get eju() {
    return ParamFactory.eju(this);
  }
  // [ha={y|n};]
  get ha() {
