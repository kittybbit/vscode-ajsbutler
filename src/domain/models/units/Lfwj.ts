...
export class Lfwj extends UnitEntity {
  ...
  // [lffnm="log-file-name";]
  get lffnm() {
    return ParamFactory.lffnm(this);
  }
  // [lfdft={s|s2|w1|w2};]
  get lfdft() {
    return ParamFactory.lfdft(this);
  }
  // [lfrft={v:'[\]delimiter'|f:record-length};]
  get lfrft() {
    return ParamFactory.lfrft(this);
  }
  // [lfhds={l:header-row-count|s:header-size};]
  get lfhds() {
    return ParamFactory.lfhds(this);
  }
  // [lfmks=[!]"data-1-other-than-log-information"
  get lfmks() {
    return ParamFactory.lfmks(this);
  }
  //      [: [!]"data-2-other-than-log-information"...];]
  // [lfsiv=file-monitoring-interval;]
  get lfsiv() {
    return ParamFactory.lfsiv(this);
  }
  // [lfmxl=maximum-event-data-length;]
  get lfmxl() {
    return ParamFactory.lfmxl(this);
  }
  // [lfsrc={y|n};]
  get lfsrc() {
    return ParamFactory.lfsrc(this);
  }
  // [lfcre={y|n};]
  get lfcre() {
    return ParamFactory.lfcre(this);
  }
