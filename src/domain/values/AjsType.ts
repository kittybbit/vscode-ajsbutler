/** unit types */
export const TySymbols = ['g', 'mg', 'n', 'rn', 'rm', 'rr', 'rc', 'mn', 'j', 'rj', 'pj', 'rp', 'qj', 'rq',
...
export type TySymbol = typeof TySymbols[number];
export const isTySymbol = (ty: string): ty is TySymbol => TySymbols.some((v) => v === ty);

/** unit definition parameter type */
const ParamSymbols = ['ab', 'abr', 'ar', 'cd', 'cftd', 'cgs', 'cl', 'cm', 'cmaif', 'cmsts', 'cond',
...
export type ParamSymbol = typeof ParamSymbols[number];
export const isParamSymbol = (param: string): param is ParamSymbol => ParamSymbols.some((v) => v === param);

/** week */
const WeekSymbols = ['su', 'mo', 'tu', 'we', 'th', 'fr', 'sa'] as const;
export type WeekSymbol = typeof WeekSymbols[number];
export const isWeekSymbol = (week?: string): week is WeekSymbol => WeekSymbols.some((v) => v === week);