...
export const AJS_SEMANTIC_DIFF_EXPLORER_NAME = "semanticDiffExplorer";
export const AJS_SEMANTIC_DIFF_EXPLORER_TYPE = `${EXTENSION_ID}.${AJS_SEMANTIC_DIFF_EXPLORER_NAME}`;
export const AJS_SEMANTIC_DIFF_EXPLORER_BUNDLE_SRC =
...
export const getViewerBundleSrc = (viewType: string): string => {
  switch (viewType) {
    ...
    case AJS_SEMANTIC_DIFF_EXPLORER_TYPE:
      return AJS_SEMANTIC_DIFF_EXPLORER_BUNDLE_SRC;
    default:
