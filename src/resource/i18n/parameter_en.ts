export const en = {
  ...
  ej: {
    syntax:
      "{gt|ge|lt|le|eq|ne|ri|ro|ef|nf|vgt|vge|vlt|vle|veq|vne|vri|vro|sce|spe|sne|spn|snn|snl}",
  },
  ejc: {
  ...
  lfmks: {
    syntax:
      '[!]"data-1-other-than-log-information"[: [!]"data-2-other-than-log-information"...]',
  },
  lfmxl: {
  ...
  unit: {
    syntax:
      "unit-name[, [permission-mode][, [JP1-user-name][, [JP1-resource-group-name]]]]",
  },
  wc: {
    syntax: "[N,]{no|n|un}",
  },
