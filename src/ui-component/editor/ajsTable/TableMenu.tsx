...
const TableMenu: FC<TableMenuProps> = ({ tableMenuState, drawerWidthState }) => {
        ...
        <>
            ...
            >
                ...
                <MenuItem
                    ...
                    {scrollType === 'table' && <ListItemText>{localeMap('table.menu.menuItem2.window', lang)}</ListItemText>}
                    {scrollType === 'window' && <ListItemText>{localeMap('table.menu.menuItem2.table', lang)}</ListItemText>}
                </MenuItem>
            </Menu >
        </>
    );
