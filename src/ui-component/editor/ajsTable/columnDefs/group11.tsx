...
const group11 = (
  ...
  return columnHelper.group({
    ...
    header: ajsTableColumnLabels.label("group11"),
    columns: [
      {
        id: "group11.col1",
        header: ajsTableColumnLabels.label("group11.col1"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.commandText,
      },
      {
        id: "group11.col2",
        header: ajsTableColumnLabels.label("group11.col2"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.scriptFileName,
      },
      {
        id: "group11.col3",
        header: ajsTableColumnLabels.label("group11.col3"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.parameters,
      },
      {
        id: "group11.col4",
        header: ajsTableColumnLabels.label("group11.col4"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.environmentVariable,
      },
      {
        id: "group11.col5",
        header: ajsTableColumnLabels.label("group11.col5"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.environmentVariableFile,
      },
      {
        id: "group11.col6",
        header: ajsTableColumnLabels.label("group11.col6"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.workPathName,
      },
      {
        id: "group11.col7",
        header: ajsTableColumnLabels.label("group11.col7"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.standardInputFile,
      },
      columnHelper.group({
        id: "group11.group1",
        header: ajsTableColumnLabels.label("group11.group1"),
        columns: [
          {
            id: "group11.group1.col1",
            header: ajsTableColumnLabels.label("group11.group1.col1"),
            accessorFn: (row) =>
              rowViewByPath.get(row.absolutePath)?.group11.standardOutputFile,
          },
          {
            id: "group11.group1.col2",
            header: ajsTableColumnLabels.label("group11.group1.col2"),
            accessorFn: (row) =>
      ...
      columnHelper.group({
        id: "group11.group2",
        header: ajsTableColumnLabels.label("group11.group2"),
        columns: [
          {
            id: "group11.group2.col1",
            header: ajsTableColumnLabels.label("group11.group2.col1"),
            accessorFn: (row) =>
              rowViewByPath.get(row.absolutePath)?.group11.standardErrorFile,
          },
          {
            id: "group11.group2.col2",
            header: ajsTableColumnLabels.label("group11.group2.col2"),
            accessorFn: (row) =>
      ...
      {
        id: "group11.col8",
        header: ajsTableColumnLabels.label("group11.col8"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.queueManager,
      },
      {
        id: "group11.col9",
        header: ajsTableColumnLabels.label("group11.col9"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.queueName,
      },
      {
        id: "group11.col10",
        header: ajsTableColumnLabels.label("group11.col10"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.requestJobName,
      },
      {
        id: "group11.col11",
        header: ajsTableColumnLabels.label("group11.col11"),
        accessorFn: (row) =>
      ...
      columnHelper.group({
        id: "group11.group3",
        header: ajsTableColumnLabels.label("group11.group3"),
        columns: [
          {
            id: "group11.group3.col1",
            header: ajsTableColumnLabels.label("group11.group3.col1"),
            accessorFn: (row) =>
              rowViewByPath.get(row.absolutePath)?.group11.endJudgment,
          },
          {
            id: "group11.group3.col2",
            header: ajsTableColumnLabels.label("group11.group3.col2"),
            accessorFn: (row) =>
              rowViewByPath.get(row.absolutePath)?.group11.waitThreshold,
          },
          {
            id: "group11.group3.col3",
            header: ajsTableColumnLabels.label("group11.group3.col3"),
            accessorFn: (row) =>
              rowViewByPath.get(row.absolutePath)?.group11.timeoutHold,
          },
          {
            id: "group11.group3.col4",
            header: ajsTableColumnLabels.label("group11.group3.col4"),
            accessorFn: (row) =>
      ...
      {
        id: "group11.col12",
        header: ajsTableColumnLabels.label("group11.col12"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.automaticRetryEnabled,
      },
      columnHelper.group({
        id: "group11.group4",
        header: ajsTableColumnLabels.label("group11.group4"),
        columns: [
          {
            id: "group11.group4.col1",
            header: ajsTableColumnLabels.label("group11.group4.col1"),
            accessorFn: (row) =>
              rowViewByPath.get(row.absolutePath)?.group11.retryStart,
          },
          {
            id: "group11.group4.col2",
            header: ajsTableColumnLabels.label("group11.group4.col2"),
            accessorFn: (row) =>
      ...
      {
        id: "group11.col13",
        header: ajsTableColumnLabels.label("group11.col13"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.retryCount,
      },
      {
        id: "group11.col14",
        header: ajsTableColumnLabels.label("group11.col14"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group11.retryInterval,
      },
      {
        id: "group11.col15",
        header: ajsTableColumnLabels.label("group11.col15"),
        accessorFn: (row) =>
