...
const group12 = (
  ...
  return columnHelper.group({
    ...
    columns: [
      ...
      {
        id: "group12.col2",
        header: ajsTableColumnLabels.label("group12.col2"),
        accessorFn: (row) =>
          rowViewByPath.get(row.absolutePath)?.group12.variableName,
      },
      {
        id: "group12.col3",
        header: ajsTableColumnLabels.label("group12.col3"),
        accessorFn: (row) =>
